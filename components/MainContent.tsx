            ...
            <div className="grid lg:grid-cols-2 gap-32 items-center">
              <div>
                ...
                <div className="flex flex-col gap-4 max-w-xl">
                  ...
                  <a href="https://github.com/ibuildrun" target="_blank" className="group flex items-center justify-between p-12 border-2 hover:invert transition-all" style={{ borderColor: 'var(--border)', color: 'var(--fg)' }}>
                      <span className="text-[9px] font-bold uppercase tracking-[0.6em]">GitHub: ibuildrun</span>
                      <ArrowRight size={22} className="group-hover:translate-x-4 transition-transform" />
                  </a>
                </div>
              </div>

...
const MainContent: React.FC = () => {
  ...
  return (
    <div className={`relative min-h-screen overflow-x-hidden font-mono text-sm md:text-base transition-colors duration-500 ${isCrtOn ? 'crt-effect' : ''}`}>
      <SEOHead lang={lang} />
      ...
      <div className="no-print">
        ...
        <div className="fixed left-4 top-0 h-full w-8 pointer-events-none z-40 hidden lg:flex flex-col text-[11px] select-none pt-32" style={{ color: 'var(--muted)', opacity: 0.4 }}>
          ...
          {showNav && (
            ...
            >
              <div className="flex items-center gap-3 md:gap-6">
                ...
                <div className="hidden md:flex items-center gap-2 text-[11px] uppercase tracking-[0.3em]" style={{ color: 'var(--muted)' }}>
                  <div className="w-1.5 h-1.5 rounded-full animate-pulse" style={{ backgroundColor: 'var(--accent)' }} />
                  {t.nav.system_stable}: v2.4.0
                </div>
              </div>
              
              <div className="hidden lg:flex gap-12 text-[12px] uppercase tracking-[0.4em] font-bold" style={{ color: 'var(--fg)' }}>
              ...
              <div className="flex gap-2 md:gap-4">
                ...
                >
                  ...
                  <span className="uppercase text-[12px] md:text-sm">{lang}</span>
                </button>
                <button 
        ...
        <section id="home" className="h-screen flex flex-col items-center justify-center p-4 md:p-6 text-center relative overflow-hidden bg-transparent border-b" style={{ borderColor: 'var(--border)' }}>
          <div className="absolute top-32 left-12 text-[11px] hidden xl:block pointer-events-none text-left leading-relaxed font-bold opacity-20" style={{ color: 'var(--fg)' }}>
          ...
          >
            <pre className="text-[6px] sm:text-[8px] md:text-[10px] mb-8 md:mb-12 select-none leading-none font-bold opacity-30 hidden sm:block" style={{ color: 'var(--fg)' }}>
              {`
   ...
   |___||___| \\___/ |___||____| |_|_\\ |__|  \\___/ |_|\\__|
            ...
            <motion.div 
              ...
              animate={{ opacity: 1 }}
              transition={{ delay: 1 }}
              className="text-[11px] md:text-sm mb-10 md:mb-16 tracking-[0.4em] md:tracking-[0.6em] uppercase flex items-center justify-center gap-2 md:gap-4 font-bold px-4"
            ...
            >
              <a href="#projects" className="px-8 py-4 md:px-12 md:py-6 font-bold border-2 uppercase tracking-[0.3em] md:tracking-[0.4em] text-[12px] md:text-sm hover:invert transition-all" style={{ backgroundColor: 'var(--accent)', color: 'var(--bg)', borderColor: 'var(--accent)' }}>
                {t.hero.cta}
              </a>
            </motion.div>
          </motion.div>
          ...
          >
            <span className="text-[11px] md:text-[12px] uppercase tracking-[0.4em] md:tracking-[0.5em] font-bold" style={{ color: 'var(--fg)' }}>{t.hero.trace}</span>
        ...
        <section id="stack" className="py-24 md:py-48 px-4 md:px-6 border-t overflow-hidden relative z-10" style={{ borderColor: 'var(--border)', backgroundColor: 'var(--bg)' }}>
          <div className="max-w-[1200px] mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 md:mb-32 gap-6 md:gap-12">
              <div>
                <div className="text-[11px] md:text-[12px] uppercase tracking-[0.4em] md:tracking-[0.6em] mb-4 font-bold" style={{ color: 'var(--muted)' }}>{t.stack.inventory}</div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-px border-2 shadow-xl" style={{ backgroundColor: 'var(--border)', borderColor: 'var(--border)' }}>
              {TECH_STACK.map((tech) => (
                <div key={tech.name} className="p-8 md:p-14 transition-all flex flex-col items-center justify-center text-center hover:opacity-80 border" style={{ backgroundColor: 'var(--bg)', borderColor: 'var(--border)' }}>
                  <span className="text-[10px] md:text-[11px] mb-4 md:mb-8 opacity-60 uppercase tracking-[0.3em] md:tracking-[0.4em] font-bold" style={{ color: 'var(--fg)' }}>{tech.category}</span>
                  <h3 className="text-[12px] md:text-sm font-bold uppercase tracking-[0.1em] md:tracking-[0.2em]" style={{ color: 'var(--fg)' }}>{tech.name}</h3>
        ...
        <section id="contact" className="py-24 md:py-48 px-4 md:px-6 border-t relative z-10" style={{ borderColor: 'var(--border)', backgroundColor: 'var(--bg)' }}>
          <div className="max-w-[1200px] mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 md:gap-32 items-center">
              <div>
                <div className="text-[11px] md:text-[12px] uppercase tracking-[0.6em] md:tracking-[1em] mb-8 md:mb-12 font-bold" style={{ color: 'var(--muted)' }}>{t.contact.interface}</div>
                ...
                <div className="flex flex-col gap-3 md:gap-4 max-w-xl">
                  <a href="https://t.me/ibuildrun" target="_blank" className="group flex items-center justify-between p-6 md:p-12 border-2 hover:invert transition-all" style={{ borderColor: 'var(--border)', color: 'var(--fg)' }}>
                      <span className="text-[11px] md:text-[12px] font-bold uppercase tracking-[0.4em] md:tracking-[0.6em]">Telegram: @ibuildrun</span>
                  ...
                  <a href="https://github.com/ibuildrun" target="_blank" className="group flex items-center justify-between p-6 md:p-12 border-2 hover:invert transition-all" style={{ borderColor: 'var(--border)', color: 'var(--fg)' }}>
                      <span className="text-[11px] md:text-[12px] font-bold uppercase tracking-[0.4em] md:tracking-[0.6em]">GitHub: ibuildrun</span>
                      <ArrowRight size={18} className="group-hover:translate-x-4 transition-transform md:w-[22px] md:h-[22px]" />
                  </a>
                </div>
              </div>
        ...
        <footer className="py-16 md:py-32 border-t text-center px-4 md:px-6 relative z-10" style={{ borderColor: 'var(--border)', backgroundColor: 'var(--bg)' }}>
          <div className="absolute bottom-12 right-12 text-[10px] text-right hidden lg:block select-none pointer-events-none uppercase tracking-[0.3em] font-bold leading-loose opacity-30" style={{ color: 'var(--fg)' }}>
          ...
          >
            <div className="text-[11px] md:text-[12px] font-bold uppercase tracking-[0.8em] md:tracking-[1.2em] transition-colors mb-6 md:mb-8" style={{ color: 'var(--muted)' }}>{t.contact.reload}</div>
          ...
          <div className="text-[11px] md:text-[12px] uppercase tracking-[0.4em] md:tracking-[0.6em] font-bold" style={{ color: 'var(--muted)' }}>

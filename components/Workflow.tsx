    ...
    <section id="workflow" className="min-h-screen py-24 md:py-48 px-6 md:px-24 z-10 relative overflow-hidden border-t bg-transparent" style={{ borderColor: 'var(--border)' }}>
      <div className="max-w-7xl mx-auto">
        <div className="mb-16 md:mb-24 text-center md:text-left">
          ...
          <p className="font-mono text-[10px] md:text-xs tracking-[0.3em] md:tracking-[0.4em] uppercase" style={{ color: 'var(--muted)' }}>
        ...
        <div className="relative">
              ...
              >
                <div className="flex flex-col items-center md:items-start space-y-6 md:space-y-8">
                  ...
                  <div className={`space-y-4 transition-opacity duration-300 text-center md:text-left`} style={{ opacity: activeIndex === idx ? 1 : 0.4 }}>
                    ...
                    <p className="text-[10px] md:text-xs leading-relaxed max-w-[250px] font-bold uppercase tracking-tight mx-auto md:mx-0" style={{ color: 'var(--muted)' }}>
          ...
          <div className="mt-20 md:mt-32 p-6 md:p-10 border-2 backdrop-blur-md flex flex-col md:flex-row justify-between items-center gap-8" style={{ backgroundColor: 'rgba(0,0,0,0.03)', borderColor: 'var(--border)' }}>
            <div className="flex items-center gap-6">
              ...
              <div>
                <div className="text-[9px] md:text-[10px] font-bold uppercase tracking-[0.4em]" style={{ color: 'var(--muted)' }}>{t.workflow.status}</div>
            ...
            <div className="text-center md:text-right font-bold text-[9px] md:text-xs tracking-widest uppercase" style={{ color: 'var(--muted)' }}>
